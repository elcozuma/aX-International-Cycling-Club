  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: ["The aim is not racing, but participants are expected to arrive with an appropriate level of fitness and preparation. Depending on the route and conditions, regrouping points may exist throughout the day.", "Be reassured that a-X event hosts will never leave a rider behind."]
      },
      {
