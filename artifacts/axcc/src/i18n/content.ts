  ...
  moroccoCategories: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: "What happens if the event is cancelled?", a: "If a-X cancels the Expedition and the event does not proceed, all a-X Expedition Fees paid by participants, including deposits, will be refunded in full. a-X will not be responsible for separately booked flights, accommodation, travel or other third-party costs, and participants are strongly advised to ensure these are covered by appropriate travel insurance." },
      ]
    },
  ],
};
  ...
  moroccoCategories: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: "Comment et quand dois-je payer pour l'événement ?", a: "Les frais d'inscription a-X de 400 € sont réglés en deux versements : un acompte de 200 € à la réservation, suivi des 200 € restants avant le 31 janvier 2027. Les paiements sont traités en toute sécurité via Stripe. L'acompte est non remboursable. Cependant, à la discrétion d'a-X, il peut être transféré en crédit vers une future expédition ou cédé à un autre participant. L'hébergement et la logistique optionnelle sont distincts des frais a-X et sont fournis par notre partenaire local au Maroc. Ces coûts s'élèvent à jusqu'à 550 € par personne, selon le nombre final de participants et les options choisies, et sont réglés directement auprès du prestataire local. Les détails de paiement complets et le montant final seront confirmés une fois le nombre de participants connu." },
    ...
    },
    {
      ...
      items: [
        ...
        { q: "Que se passe-t-il si l'événement est annulé ?", a: "Si a-X annule l'Expédition et que l'événement n'a pas lieu, tous les Frais d'Expédition a-X payés par les participants, y compris les acomptes, seront intégralement remboursés. a-X ne sera pas responsable des vols, hébergements, voyages ou autres coûts tiers réservés séparément, et les participants sont vivement conseillés de s'assurer que ces dépenses sont couvertes par une assurance voyage appropriée." },
      ]
    },
  ],
};
  ...
  moroccoCategories: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: "¿Qué ocurre si el evento se cancela?", a: "Si a-X cancela la Expedición y el evento no se lleva a cabo, todos los Honorarios de Expedición a-X pagados por los participantes, incluidos los depósitos, serán reembolsados en su totalidad. a-X no será responsable de los vuelos, alojamientos, viajes u otros costes de terceros reservados por separado, y se recomienda encarecidamente a los participantes que se aseguren de que estos están cubiertos por un seguro de viaje adecuado." },
      ]
    },
  ],
};
  ...
  moroccoCategories: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: "Cosa succede se l'evento viene annullato?", a: "Se a-X annulla la Spedizione e l'evento non si svolge, tutte le Quote di Spedizione a-X pagate dai partecipanti, inclusi i depositi, saranno rimborsate integralmente. a-X non sarà responsabile per voli, alloggi, viaggi o altri costi di terze parti prenotati separatamente, e si raccomanda vivamente ai partecipanti di assicurarsi che questi siano coperti da un'adeguata assicurazione di viaggio." },
      ]
    },
  ],
};
  ...
  moroccoCategories: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: "Was passiert, wenn die Veranstaltung abgesagt wird?", a: "Wenn a-X die Expedition absagt und die Veranstaltung nicht stattfindet, werden alle von den Teilnehmern gezahlten a-X Expeditionsgebühren, einschließlich Anzahlungen, vollständig erstattet. a-X übernimmt keine Verantwortung für separat gebuchte Flüge, Unterkünfte, Reisen oder andere Kosten Dritter, und den Teilnehmern wird dringend empfohlen, sicherzustellen, dass diese durch eine geeignete Reiseversicherung abgedeckt sind." },
      ]
    },
  ],
};
...
const moroccoPages: Record<Language, MoroccoPage> = {
  en: {
    ...
    expressInterest: "BOOK NOW",
    noPayment: "Deposit required to secure booking.",
  ...
  fr: {
    ...
    expressInterest: "RÉSERVER MAINTENANT",
    noPayment: "Un dépôt est requis pour confirmer la réservation.",
  ...
  es: {
    ...
    expressInterest: "RESERVAR AHORA",
    noPayment: "Se requiere depósito para confirmar la reserva.",
  ...
  it: {
    ...
    expressInterest: "PRENOTA ORA",
    noPayment: "È richiesto un deposito per confermare la prenotazione.",
  ...
  de: {
    ...
    expressInterest: "JETZT BUCHEN",
    noPayment: "Anzahlung zur Buchungsbestätigung erforderlich.",
